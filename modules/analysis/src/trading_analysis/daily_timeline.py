...
def render_timeline_page(
    ...
    *,
    ...
    lines.append("")
    lines.append(
        "Navigation: [Enter day #] View | [R] Date range | [N] Next page | [P] Previous page | "
        "[S] Symbol PnL | [K] Kelly | [T] Profitable timeline | [U] TPO quality | [Q] Quit"
    )
    return "\n".join(lines)
...
def render_day_detail(day_entries: Sequence[DayPnL], index: int) -> str:
    ...
    if day.losers_lines:
        ...
        lines.append("  - None")
    lines.append("=" * 72)
    lines.append("Navigation: [B] Back | [R] Date range | [N] Next day | [P] Previous day | [S] Symbol PnL | [K] Kelly | [T] Profitable timeline | [U] TPO quality | [Q] Quit")
    return "\n".join(lines)
